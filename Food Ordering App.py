...
def register_user(user_json,name,password,email,address,phone):
    user={
        "id":1,
        "name":name,
        "password":password,
...
def update_userProfile(user_json,user_id,name,password,email,phone,address):
    flag=0
    file=open(user_json,"r+")
    content=json.load(file)
    for i in range(len(content)):
                        ...
                        if content[i]["password"]==password:
                            ...
                            while True:
                                ...
                                if val3=="1":
                                    ...
                                    update_userProfile("user.json",user_id,name,password,email,phn,address)
